...
Tehtävien teko on aloitettu 5.5.2024 klo 15.35 ja päätetty XX.2024 klo XXXX.

## Tehtävä x - Lue ja tiivistä
Tehtävä aloitettu 5.5.2024 klo 15.40 ja valmis klo XXXX.
...
Tarkastetaan asennus komennolla `sudo apt list --installed | grep -e python3-pip -e python3-pygit2`, sillä sen pitäisi myös asentaa automaattisesti `pygit2`.
...
Python `pip`-asennus onnistui normaalisti ja sen osana asennettiin myös `pygit2`.
